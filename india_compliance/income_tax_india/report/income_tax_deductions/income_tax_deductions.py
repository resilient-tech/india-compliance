...
import erpnext
from erpnext.payroll.report.income_tax_deductions.income_tax_deductions import execute as execute_erpnext_report
...
def execute(filters=None, **kwargs):
	...
	if (
		erpnext.get_region() != "India"
		or any(column.get("fieldname") == "pan_number" for column in columns)
	):
		return columns, data
