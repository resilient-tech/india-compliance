...
class TestTdsComputationSummaryIndia(IntegrationTestCase):
    ...
    def test_additional_column_and_data_in_row(self):
        ...
        self.assertIsNotNone(supplier_row)
        self.assertEqual(supplier_row.get("tds_section"), "194J")
        self.assertEqual(supplier_row.get("old_income_tax_section"), "194J-OLD")
        self.assertEqual(supplier_row.get("entity_type"), "Individual")
