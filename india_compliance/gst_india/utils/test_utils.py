...
class TestUtils(IntegrationTestCase):
    ...
    def test_guess_gst_category_for_oidar(self):
        for country in (None, "India", "Singapore"):
            self.assertEqual(guess_gst_category("9917SGP29001OST", country), "Overseas", country)
