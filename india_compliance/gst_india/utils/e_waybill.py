...
def generate_e_waybill_json(
    doctype: str, docnames: str, values: str | None = None
) -> str:
...
def bulk_update_transporter_in_docs(
    doctype: str, docnames: str, values: dict | str
) -> None:
...
@frappe.whitelist()
def enqueue_bulk_e_waybill_generation(doctype: str, docnames: list[str] | str) -> str:
    """
...
def generate_e_waybill(
    *, doctype: str, docname: str, values: dict | str | None = None, force: bool = False
) -> None:
    doc = load_doc(doctype, docname, "submit")
    if values:
        update_transaction(doc, frappe.parse_json(values))
...
@frappe.whitelist()
def cancel_e_waybill(*, doctype: str, docname: str, values: dict | str) -> None:
...
@frappe.whitelist()
def update_vehicle_info(*, doctype: str, docname: str, values: dict | str) -> None:
    doc = load_doc(doctype, docname, "submit")
...
@frappe.whitelist()
def update_transporter(*, doctype: str, docname: str, values: dict | str) -> None:
    doc = load_doc(doctype, docname, "submit")
...
@frappe.whitelist()
def extend_validity(
    *, doctype: str, docname: str, values: dict | str, scheduled: bool = False
) -> None:
    doc = load_doc(doctype, docname, "submit")
    values = frappe.parse_json(values)
...
@frappe.whitelist()
def find_matching_e_waybill(*, doctype: str, docname: str, e_waybill_date: str) -> None:
    doc = load_doc(doctype, docname, "submit")
...
@frappe.whitelist()
def mark_e_waybill_as_generated(doctype: str, docname: str, values: dict | str) -> None:
    doc = load_doc(doctype, docname, "submit")
    values = frappe.parse_json(values)
    result = {
...
@frappe.whitelist()
def mark_e_waybill_as_cancelled(doctype: str, docname: str, values: dict | str) -> None:
    doc = load_doc(doctype, docname, "cancel")
    values = frappe.parse_json(values)
    result = frappe._dict(
        {
...
@frappe.whitelist()
def get_source_destination_address(
    doctype: str, docname: str, address_type: str
) -> Document:
