...
@frappe.whitelist()
def request_otp(company_gstin: str) -> dict:
...
@frappe.whitelist()
@otp_handler
def authenticate_otp(company_gstin: str, otp: str) -> dict:
    frappe.has_permission("GST Settings", throw=True)
...
@frappe.whitelist()
@otp_handler
def generate_evc_otp(company_gstin: str, pan: str, request_type: str) -> dict:
