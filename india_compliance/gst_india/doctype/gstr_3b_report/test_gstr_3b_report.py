...
class TestGSTR3BReport(unittest.TestCase):
    ...
    def test_gstr_3b_report(self):
        ...
        if frappe.db.exists(
            "GSTR 3B Report", "GSTR3B-March-2019-_Test Address GST-Billing"
        ):
...
def make_suppliers():
    ...
    if not frappe.db.exists("Address", "_Test Supplier GST-2-Billing"):
        ...
        address.append(
            "links",
            {"link_doctype": "Supplier", "link_name": "_Test Unregistered Supplier"},
        )
...
def make_customers():
    ...
    if not frappe.db.exists("Address", "_Test GST-1-Billing"):
        ...
        address.append(
            "links", {"link_doctype": "Customer", "link_name": "_Test GST Customer"}
        )
    ...
    if not frappe.db.exists("Address", "_Test GST-2-Billing"):
        ...
        address.append(
            "links",
            {"link_doctype": "Customer", "link_name": "_Test Unregistered Customer"},
        )
    ...
    if not frappe.db.exists("Address", "_Test GST-3-Billing"):
        ...
        address.append(
            "links", {"link_doctype": "Customer", "link_name": "_Test GST SEZ Customer"}
        )
...
def make_company():
    ...
    if not frappe.db.exists("Address", "_Test Address GST-Billing"):
        ...
        address.append(
            "links", {"link_doctype": "Company", "link_name": "_Test Company GST"}
        )
