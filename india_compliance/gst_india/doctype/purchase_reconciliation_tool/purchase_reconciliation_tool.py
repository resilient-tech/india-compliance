...
class PurchaseReconciliationTool(Document):
    ...
    @frappe.whitelist()
    def upload_gstr(self, return_type: str, period: str, file_path: str) -> None:
        frappe.has_permission("Purchase Reconciliation Tool", "write", throw=True)
    ...
    @frappe.whitelist()
    def get_return_period_from_file(
        self, return_type: str, file_path: str
    ) -> str | None:
        """
    ...
    @frappe.whitelist()
    def get_date_range(self, period: str) -> list | None:
        """
        Permissions check not necessary as response is not sensitive
        """
    ...
    @frappe.whitelist()
    def get_date_range_and_check_missing_documents(self, period: str) -> list | None:
    ...
    @frappe.whitelist()
    def apply_action(self, data: str, action: str) -> None:
        frappe.has_permission("Purchase Reconciliation Tool", "write", throw=True)
    ...
    @frappe.whitelist()
    def get_link_options(self, doctype: str, filters: dict) -> list:
        frappe.has_permission("Purchase Reconciliation Tool", "write", throw=True)
