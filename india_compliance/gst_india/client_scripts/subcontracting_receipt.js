...
frappe.ui.form.on("Subcontracting Receipt", {
    ...
    onload(frm) {
        frm.subcontracting_receipt_controller = new SubcontractingReceiptController(frm);
    },
...
class SubcontractingReceiptController {
    constructor(frm) {
        this.frm = frm;
...
class TaxesController {
    ...
    async update_tax_amount(cdt, cdn) {
        ...
        this.frm.subcontracting_receipt_controller.update_total_taxes();
    }
