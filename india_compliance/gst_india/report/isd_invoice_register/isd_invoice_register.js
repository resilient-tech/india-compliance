...
// Amount columns that should be summed in the total row. Returns (Purchase Invoice view) and
// credit notes (ISD views) are already stored negative, so a plain sum nets them out.
const AMOUNT_FIELDS = [
    ...
    "distributed_cess",
    "distributed_expense",
    // ISD Recipient Invoice view — received
    "recipient_igst",
    "recipient_cgst",
    "recipient_sgst",
    "recipient_cess",
