...
def get_distribution_invoice_data(filters):
    ...
    query = (
        ...
        .select(
            ...
            dist.party_pos,
            dist.is_credit_note,
            dist.is_ineligible_for_itc,
            Case().when(dist.is_ineligible_for_itc == 0, "Eligible").else_("Ineligible").as_("eligibility"),
        ...
        .groupby(dist.name, dist.is_ineligible_for_itc)
...
def get_recipient_invoice_data(filters):
    ...
    query = (
        ...
        .select(
            ...
            rec.is_credit_note,
            rec.is_ineligible_for_itc,
            Case().when(rec.is_ineligible_for_itc == 0, "Eligible").else_("Ineligible").as_("eligibility"),
        ...
        .groupby(rec.name, rec.is_ineligible_for_itc)
