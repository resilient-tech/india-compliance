...
regional_overrides = {
	'India': {
		'erpnext.controllers.taxes_and_totals.get_itemised_tax_breakup_header': 'india_compliance.gst_india.overrides.taxes_and_totals.get_itemised_tax_breakup_header',
